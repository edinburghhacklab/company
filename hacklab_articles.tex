% Edinburgh Hacklab articles 
\documentclass{article}
\usepackage{graphicx}
\usepackage{palatino}
%\usepackage{draftwatermark}
\title{Articles of Edinburgh Hacklab Ltd}
\date{2nd July 2020}
...
\begin{titlepage}
  ...
  \begin{center}
    ...
    \textsc{\LARGE Edinburgh Hacklab}\\[1.5cm]
...
\section{General}
\subsection{Name}
\clause{The name of the organisation shall be ``Edinburgh Hacklab Ltd'', 
...
\clause{In the articles:}
  ...
  \item[Writing] means the representation or reproduction of words, symbols or
...
\clause{\label{clause:zero_liability}The liability of the members is limited to a sum not exceeding \pounds1,
  being the amount that each member undertakes to contribute to the
  assets of the Hacklab in the event of its being wound up while they are a member or within one year after they cease
  to be a member, for:}
  \begin{enumerate}
  \item
    payment of the company's debts and liabilities incurred before they cease to be a member;
  \item
...
\clause{Membership is open to any individual aged 16 or over.}
...
\subsubclause{their full name and address; and}
...
\subsubclause{the date on which they ceased to be a member.}
...
\clause{A person shall cease to be a member upon death.}

\subsection{Transfer of membership}

\clause{Membership of the Hacklab shall not be transferrable.}
...
meeting or ``AGM'') in the month of May each calendar year.}
...
\subsection{Participation in meetings}

% Model articles 2018-09-18 section 10. (1)
\clause{People participate in a meeting, or part of a meeting, when
the meeting has been called and takes place in accordance with the
articles, and they can each communicate to the others any information
or opinions they have on any particular item of the business of the
meeting.}

% Model articles 2018-09-18 section 10. (2)
\clause{In determining whether a person is participating in a meeting,
it is irrelevant where any person is or how they communicate with each
other.}

% Model articles 2018-09-18 section 10. (3)
\clause{If all the people participating in a meeting are not in the
same place, they may decide that the meeting is to be treated as
taking place wherever any of them is.}

% Model articles 2018-09-18 section 23. (3)
\clause{The directors may make whatever arrangements they consider
appropriate to enable those attending a meeting to exercise their
rights to speak or vote at it.}

% Model articles 2018-09-18 section 23. (4)
\clause{In determining attendance at a meeting, it is immaterial
...
\clause{The quorum for a general meeting is 10 members or one half of the membership
at the time of the meeting, whichever is fewer.}
...
\clause{\label{clause:supermajority}The following resolutions will be valid
only if passed by not less that two-thirds of those voting on the resolution
at an AGM or EGM (or if passed by way of a written resolution by not less than
two-thirds of eligible members under clause \ref{clause:writtenresolution}):}
...
decided on a show of hands or on a poll - unless the chair (or at
least two other members present at the meeting) ask for a secret
ballot.}
...
\clause{\label{clause:proxy}Proxies may only validly be appointed by a notice in writing (a "proxy notice")
which}
...
\clause{\label{clause:writtenresolution}A resolution agreed to in writing by a
  majority will be as valid as if it had been passed at a general meeting; the
  date of the resolution will be taken to be the date on which the threshold
  for a majority is reached.}
  \subclause{A written resolution is passed by a majority if it is passed by
  members representing not less than half of the total voting rights of
  eligible members; with the exception of}
  \subclause{the types of resolution listed in clause
  \ref{clause:supermajority} which will be passed by members representing not
  less than two-thirds of the total voting rights of eligible members.}
...
\clause{A person will not be eligible for
  election to the board unless they are a member of the Hacklab.}
...
\subclause{the period between the date of election of a director
and the AGM which next follows shall be deemed to be a period
...
\subclause{if a director ceases to hold office but is
...
\subclause{They become disqualified from being a director
under the \companyact;}

\subclause{a bankruptcy order is made against them;}

\subclause{a composition is made with their creditors generally in satisfaction of that
person's debts;}

\subclause{they become incapable for medical reasons of carrying
out their duties as a director - but only if that has
...
\subclause{for each former directors - for at least 6 years from
...
\clause{Provided they have declared their interest - and has not
  ...
  entering into an arrangement with the Hacklab in which they have a
...
any remuneration by the Hacklab for carrying out their duties as a director.}
...
\clause{\label{clause:boardquorum}No valid decisions can be taken at a
  ...
  meetings is 3 directors, participating in person.}
...
\clause{Each director has one vote, which must be given in
  person while participating in the board meeting.}
...
\clause{The board may, at its discretion, allow any person to attend
  ...
  director - but on the basis that they must not participate
  in decision-making.}
...
\clause{\label{clause:conflictofinterest}A director must not
  ...
  interests of the Hacklab; they must withdraw from the meeting
...
\clause{For the purposes of clause \ref{clause:conflictofinterest}: 
  ...
  which they are an employee, director, member of the management
...
passed at a general meeting or by way of a written resolution of the
members (subject to achieving the two-thirds majority referred to in
clause \ref{clause:supermajority}).}
